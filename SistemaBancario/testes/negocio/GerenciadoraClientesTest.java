...
public class GerenciadoraClientesTest {
	...
	public void setUp() {
		...
		Cliente cliente01 = new Cliente(idCLiente01, "Carlos Teste", 31, "carlosteste@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Carlos", 25, "carlos@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_02() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Carlos", 18, "carlos@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_03() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Carlos", 65, "carlos@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_04() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Carlos", 17, "carlos@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_05() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Carlos", 66, "carlos@gmail.com", 1, true);
		/* ========== Execução ========== */
		try {
			gerClientes.validaIdade(cliente.getIdade());
			fail();
